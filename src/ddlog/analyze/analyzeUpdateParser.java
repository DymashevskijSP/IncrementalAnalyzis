...
public class analyzeUpdateParser
{
    public analyzeUpdateParser(java.nio.ByteBuffer bb) {
        this.commands = ddlog.__analyze.__Commands.getRootAs__Commands(bb);
    }
    private ddlog.__analyze.__Commands commands;
    ...
    public static void transactionCommitDumpChanges(DDlogAPI hddlog,
        ...
        try {
            analyzeUpdateParser parser = new analyzeUpdateParser(fb.buf);
