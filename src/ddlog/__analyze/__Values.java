...
public final class __Values extends Table {
  ...
  public ddlog.__analyze.__ValueTable values(int j) { return values(new ddlog.__analyze.__ValueTable(), j); }
  public ddlog.__analyze.__ValueTable values(ddlog.__analyze.__ValueTable obj, int j) { int o = __offset(4); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int valuesLength() { int o = __offset(4); return o != 0 ? __vector_len(o) : 0; }
  public ddlog.__analyze.__ValueTable.Vector valuesVector() { return valuesVector(new ddlog.__analyze.__ValueTable.Vector()); }
  public ddlog.__analyze.__ValueTable.Vector valuesVector(ddlog.__analyze.__ValueTable.Vector obj) { int o = __offset(4); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
