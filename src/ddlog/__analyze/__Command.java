...
public final class __Command extends Table {
  ...
  public long relid() { int o = __offset(8); return o != 0 ? bb.getLong(o + bb_pos) : 0L; }
  ...
  public static void addRelid(FlatBufferBuilder builder, long relid) { builder.addLong(2, relid, 0L); }
